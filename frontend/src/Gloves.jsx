...
function Gloves({ id, size, brand, price, weightOz, onDelete, onUpdate }) {
    ...
    if (isEditing) {
        return (
            <div style={{ border: '2px solid #ff4444', margin: '10px 0', padding: '15px', borderRadius: '8px', display: 'flex', gap: '10px', backgroundColor: '#ffe5e5' }}>
    ...
    return (
        <div style={{ border: '1px solid #ccc', margin: '10px 0', padding: '15px', borderRadius: '8px', display: 'flex', justifyContent: 'space-between', backgroundColor: '#f9f9f9' }}>
